...
for week in range(1, 30):
    ...
    if resp['Count'] == 0:
        break
    if resp['Count'] < 12:
        print(f"  Skipping week {week} (only {resp['Count']} teams)")
        continue
    for item in resp['Items']:
...
with open(r'c:\Users\taylor.ward\Documents\yahoo-fantasy-baseball-dynamo\docs\luck_analysis_2026.html', 'w', encoding='utf-8') as f:
    f.write(html)

print(f'\nGenerated docs/luck_analysis_2026.html')
